...
public class BabyDroppedCriterion extends SimpleCriterionTrigger<BabyDroppedCriterion.Conditions> {
    private static final ResourceLocation ID = MCA.locate("baby_dropped");
